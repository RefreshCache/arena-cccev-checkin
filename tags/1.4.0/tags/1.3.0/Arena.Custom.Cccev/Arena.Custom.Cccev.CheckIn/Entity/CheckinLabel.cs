...
*  
*  Revision: 13   Date: 2009-10-28 21:49:21Z   User: nicka 
*  shrink font age group and room name and increase room name to 20 
*  characters. 
*  
*  Revision: 12   Date: 2009-10-08 17:18:18Z   User: JasonO 
*  Merging/updating to make changes for 1.2 release. 
*  
*  Revision: 11   Date: 2009-07-22 22:54:37Z   User: nicka 
*  Fixed bug whereby full name longer than 19 characters would not display 
*  first and last name on the Attendance Label. 
*  
*  Revision: 10   Date: 2009-02-08 04:50:40Z   User: nicka 
*  Added ShallowCopy method 
*  
*  Revision: 9   Date: 2009-02-06 23:16:30Z   User: nicka 
*  changed exception message for failed IsValid check 
*  
*  Revision: 8   Date: 2009-02-05 19:47:16Z   User: nicka 
*  remove IsValid check 
*  
*  Revision: 7   Date: 2009-02-05 18:01:45Z   User: nicka 
*  Changed exception message if printer is invalid and removed unnecessary 
*  catch throw blocks 
*  
*  Revision: 6   Date: 2009-02-04 17:15:33Z   User: JasonO 
*  changing health notes symbol to "+" 
*  
*  Revision: 5   Date: 2009-01-27 18:42:25Z   User: nicka 
*  show ":" on nametag if child has healthnotes 
*  
*  Revision: 4   Date: 2009-01-07 02:43:00Z   User: nicka 
*  No longer dies on missing images, etc.  Added line underneath AgeGroup on 
*  attendance label. 
*  
*  Revision: 2   Date: 2009-01-06 18:03:27Z   User: nicka 
*  Cleanup and rename to CheckinLabel 
*  
...
{
	/// <summary>
	/// This class represents the set of check-in labels.
	/// </summary>
	public class CheckinLabel
	{
		...
		public CheckinLabel ShallowCopy()
		{
			return (CheckinLabel)this.MemberwiseClone();
		}
		...
		private void pEvent_PrintNameTag( object sender, PrintPageEventArgs e )
		{
            ...
            if (bool.TryParse(Core.ArenaContext.Current.Organization.Settings["Cccev.DisplayRoomNameOnNameTag"], out printRoomName))
            {
                if (printRoomName)
                {
                    format.Alignment = StringAlignment.Near;
